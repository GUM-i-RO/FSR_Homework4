...
legend('$l=0.1$ m','$l=1$ m','$l=1.6$ m','$l=10$ m');
...
%exportgraphics(h, '2thetadot.pdf');
...
plot([gamma-alpha gamma-alpha], [-1 1], 'k--', 'Linewidth', lw, 'Color', [0.5, 0.5, 0.5]);
plot([gamma+alpha gamma+alpha], [-1 1], 'k--', 'Linewidth', lw, 'Color', [0.5, 0.5, 0.5]);
...
plot([gamma-alpha gamma-alpha], [0 1.5], 'k--', 'Linewidth', lw, 'Color', [0.5, 0.5, 0.5]);
plot([gamma+alpha gamma+alpha], [0 1.5], 'k--', 'Linewidth', lw, 'Color', [0.5, 0.5, 0.5]);
...
set(h, 'MenuBar', 'none');
set(h, 'ToolBar', 'none');
%exportgraphics(h, '2phasebetter.pdf');
